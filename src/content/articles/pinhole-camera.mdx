...
<figure>
  <Image src={imgEOSR5} alt="Digital Camera with lens removed" style="width:100%" />
...
<figure>
  <Image src={imgWhitescreen} alt="White screen on the back of digital camera" style="width:100%" />
...
<figure>
  <Image src={imgPinhole} alt="Digital camera with foil taped over the front" style="width:100%" />
...
<figure>
  <Image src={imgLonglens} alt="Comparison of 600mm and 10mm lenses" style="width:100%" />
...
<figure>
  <Image src={imgCoffeelens} alt="200mm pinhole lens build from a coffee tin" style="width:100%" />
